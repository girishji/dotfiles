...
iabbr <silent><buffer> fora2; for (int i{}; const auto& el : ) {<c-o>o}<esc>kf:la<C-R>=abbr#Eatchar()<CR>
...
#if
iabbr <buffer> if; if (int t{}; cin >> t) {<c-o>o}<esc>kfti<C-R>=abbr#Eatchar()<CR>
...
# iabbr <buffer> for_vector; for (const auto& x : vector{1, 2}) {<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> for_vector; for (const auto& x : {1, 2}) {<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> for_container; for (const auto& x : vector<int>{1, 2}) {<c-r>=abbr#Eatchar()<cr>
...
iabbr <buffer> increasing_strictly; = ranges::adjacent_find(vec, greater_equal<int>()) == vec.end();// see ..fn_obj less_equal<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> increasing; = ranges::adjacent_find(vec, greater<int>()) == vec.end()// see ..fn_obj less_equal;<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> decreasing_strictly; = ranges::adjacent_find(vec, less_equal<int>()) == vec.end();// see ..fn_obj less_equal<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> decreasing; = ranges::adjacent_find(vec, less<int>()) == vec.end();// see ..fn_obj less_equal<c-r>=abbr#Eatchar()<cr>
...
iabbr <buffer> smallest_int; numeric_limits<int>::min();<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> min_int; numeric_limits<int>::min();<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> largest_int; numeric_limits<int>::max();<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> max_int; numeric_limits<int>::max();<c-r>=abbr#Eatchar()<cr>

# Math
iabbr <buffer> abs; abs(<c-r>=abbr#Eatchar()<cr>

# Misc
iabbr <buffer> using; using in_list_t = list<int>;<c-r>=abbr#Eatchar()<cr>
...
iabbr <buffer> comp_equal; fabs((a / b) - (c / d)) < epsilon;<c-r>=abbr#Eatchar()<cr>

# Drop/Take the first N
iabbr <buffer> drop; \| views::drop(N)<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> drop_while; for (int n : v \| views::drop_while([](int i) { return i < 3; }))<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> take; \| views::take(N)<c-r>=abbr#Eatchar()<cr>
iabbr <buffer> take_while; for (int n : v \| views::take_while([](int i) { return i < 3; }))<c-r>=abbr#Eatchar()<cr>
...
iabbr <buffer> check_if_char_is_digit_0123456789; int isdigit(int ch);<c-r>=abbr#Eatchar()<cr>
...
# printing containers
iabbr <buffer> prv; for (const auto& t : ) { cout << t << " "; }; cout << endl;<esc>12Bi<C-R>=abbr#Eatchar()<CR>
iabbr <buffer> prc; for (const auto& t : ) { cout << t << " "; }; cout << endl;<esc>12Bi<C-R>=abbr#Eatchar()<CR>
...
iabbr <buffer> iss_reread; iss.clear(); iss.seekg(0);<c-r>=abbr#Eatchar()<cr>
