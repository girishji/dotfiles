...
func man#GetPage(cmdmods, ...)
  ...
  if &filetype != "man"
	...
	" girish: make split window at least 20 lines high
	if a:cmdmods == '' && (&lines < 40)
	  let open_cmd = '20split'
	else
  ...
  " girish
  let man_cmd = 'cppman ' . s:GetCmdArg(sect, page)
